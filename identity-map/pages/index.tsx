 ...
 * session by entering a display name, a join code, confirming
 * consent and optionally making themselves visible to others.  It
 * submits the data to the `/api/joinSession` endpoint and displays
 * success or error messages accordingly.  Form controls are disabled
    ...
    <main style={{ maxWidth: '480px', margin: '0 auto', padding: '1rem' }}>
      ...
      <form onSubmit={handleSubmit} noValidate>
        <div style={{ marginBottom: '0.75rem' }}>
          <label htmlFor="displayName" style={{ display: 'block', marginBottom: '0.25rem' }}>Alias</label>
          <input
            id="displayName"
            type="text"
            value={displayName}
        ...
        <div style={{ marginBottom: '0.75rem' }}>
          <label htmlFor="code" style={{ display: 'block', marginBottom: '0.25rem' }}>Join Code</label>
          <input
            id="code"
            type="text"
            value={code}
